...
export interface OmniSwapPairInterface extends utils.Interface {
  functions: {
    ...
    "distributeToken(address,address[],uint256[])": FunctionFragment;
  ...
  events: {
    ...
    "BurnToken(address,uint256)": EventFragment;
    "DistributeToken(address,address[],uint256[])": EventFragment;
    "Mint(address,uint256,uint256)": EventFragment;
    "Swap(address,uint256,uint256,uint256,uint256,address)": EventFragment;
    "SwapLog(address,uint256,uint256,uint256,uint256,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "SwapLog"): EventFragment;
...
export interface DistributeTokenEventObject {
  token: string;
  feeAddressList: string[];
  feePercentList: BigNumber[];
}
...
export interface SwapLogEventObject {
  sender: string;
  amount0In: BigNumber;
  amount1In: BigNumber;
  amount0Out: BigNumber;
...
export type SwapLogEvent = TypedEvent<
  [string, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber],
  SwapLogEventObject
>;

export type SwapLogEventFilter = TypedEventFilter<SwapLogEvent>;
...
export interface OmniSwapPair extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OmniSwapPairInterface;
  ...
  functions: {
    ...
    distributeToken(
      token: PromiseOrValue<string>,
      feeAddressList: PromiseOrValue<string>[],
      feeList: PromiseOrValue<BigNumberish>[],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    BurnToken(token?: null, amount?: null): BurnTokenEventFilter;
    ...
    "SwapLog(address,uint256,uint256,uint256,uint256,uint256)"(
      sender?: null,
      amount0In?: null,
      amount1In?: null,
      amount0Out?: null,
